        ...
        with sync_playwright() as playwright:
            ...
            for width, height in ((1280, 800), (640, 400), (360, 800)):
                ...
                if not baseline:
                    ...
                    self.assertEqual(page.locator('[data-comparison-header] th:not([hidden])').count(), 52)
                    ...
                    for index in (0, 49, 99):
                        ...
                        head = page.locator('[data-comparison-header] th').nth(7).bounding_box()
                        ...
                        corner = page.locator('[data-comparison-header] th').first.bounding_box()
                        self.assertAlmostEqual(corner['x'], first_column['x'], delta=1)
                    started = perf_counter()
