...
PATIENT_NAMESPACES = {"cancer_ordering", "cloud_imaging", "documents", "exports", "facts", "family_invitation", "glucose", "labs", "notifications", "patient_profile", "patients_family", "self_records", "shared", "treatments"}
