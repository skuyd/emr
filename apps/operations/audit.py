...
ALLOWED_ACTIONS = frozenset(
    {
        ...
        "lesion_created", "lesion_renamed", "lesion_relations_changed",
...
RESOURCE_TYPES = frozenset({"patient", "document", "upload_batch", "upload_item", "fact", "lab_observation",
                            ...
                            "review", "support", "quota", "dictionary", "feedback", "account", "system", "clinical_report", "self_record", "lesion", "lesion_operation"})
