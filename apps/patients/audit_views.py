...
ACTION_LABELS = {
    ...
    "treatments_viewed": "查看治疗与周期", "treatment_event_viewed": "查看治疗事件", "treatment_regimen_viewed": "查看治疗方案",
    "treatment_cycle_viewed": "查看治疗周期", "treatment_event_created": "补记治疗事件", "treatment_event_revised": "更正治疗事件",
    "treatment_regimen_created": "记录治疗方案", "treatment_regimen_revised": "更正治疗方案", "treatment_cycle_created": "组织治疗周期",
    "treatment_cycle_revised": "更正治疗周期或检查归属", "treatment_derivation_created": "保存自动周期提议",
