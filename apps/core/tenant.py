...
RESOURCE_PATIENT_ROUTES = {
    'labs:report_detail': ('labs.LabReportUnit', 'unit_id', 'parsing_version__document__patient_id'),
    'labs:report_relation': ('labs.ReportAssociation', 'association_id', 'patient_id'),
