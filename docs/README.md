...
| 文档 | 有效性 | 交付状态 | 关联版本 |
| --- | --- | --- | --- |
| [云影像来源、核对与显式访问设计](specs/2026-09-08-cloud-imaging-sources.md) | active | implementing（PR 1 已发布，PR 2/3 未交付） | 1.14.0 |
...
| 文档 | 有效性 | 交付状态 |
| --- | --- | --- |
| [云影像来源与受控访问实施计划](plans/2026-09-08-cloud-imaging-sources-implementation.md) | active | implementing（PR 1 已发布，PR 2/3 未交付） |
