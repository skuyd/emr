...
| 文档 | 有效性 | 交付状态 | 关联版本 |
| --- | --- | --- | --- |
| [检验对比产品优化方案与需求评审](specs/2026-09-14-lab-comparison-optimization.md) | active | implementing（八项完整实现及验收中） | 待确定 |
...
[检验对比优化实施计划](plans/2026-09-15-lab-comparison-optimization.md)：开发及本地验收中，版本未确定。

[检验对比优化本地验收](verification/lab-comparison-optimization.md)：合成回归与浏览器、性能验证进行中。
