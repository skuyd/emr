...
| 项目 | 当前结论 | 权威来源 |
| --- | --- | --- |
| 源代码版本 | `1.12.0`，标签 `v1.12.0` | [v1.12.0 版本清单](releases/v1.12.0.md) |
...
原 80% 周期目标尚未建立，两次真实集评分无改善。跨报告病灶关联、云影像、病理/基因字段及
日内血糖继续实施；新类型分享仍需随对应功能另行验证。
...
| 文档 | 有效性 | 交付状态 | 关联版本 |
| --- | --- | --- | --- |
| [云影像来源、核对与显式访问设计](specs/2026-09-08-cloud-imaging-sources.md) | draft | planned（待审设计，尚未实施） | 待确定 |
...
| 文档 | 有效性 | 交付状态 |
| --- | --- | --- |
| [云影像来源与受控访问实施计划](plans/2026-09-08-cloud-imaging-sources-implementation.md) | draft | planned（待审三 PR 计划） |
...
- [v1.12.0](releases/v1.12.0.md)：治疗方案、周期组织和选定派生输出；源码已发布，80% 周期质量目标未建立，当前源代码版本。
