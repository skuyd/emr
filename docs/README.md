...
| 第 3 批云影像受控打开 | PR 2 本地 HTTP、真实 PG 和 TLS 浏览器通过，等待独审/CI/合并；选定输出和有限分享仍属 PR 3 | [云影像 PR 2 验证](verification/batch-three-cloud-imaging-pr2.md) |
...
[本地验证记录](verification/batch-three-cloud-imaging-pr2.md)，当前待独审、CI 与合并；
...
| 文档 | 有效性 | 交付状态 | 关联版本 |
| --- | --- | --- | --- |
| [云影像来源、核对与显式访问设计](specs/2026-09-08-cloud-imaging-sources.md) | active | implementing（PR 1 已合入，PR 2 本地验证通过，质量限制保留） | 待确定 |
...
| 文档 | 有效性 | 交付状态 |
| --- | --- | --- |
| [云影像来源与受控访问实施计划](plans/2026-09-08-cloud-imaging-sources-implementation.md) | active | implementing（PR 2 待独审/合并，PR 3 待实施） |
...
- [第三批云影像受控打开验证](verification/batch-three-cloud-imaging-pr2.md)（PR 2 本地 75 定向、最后 22 HTTP、18 PG、6 TLS/PG 浏览器通过且无跳过；范围重叠不相加，独审/CI/合并待完成）
