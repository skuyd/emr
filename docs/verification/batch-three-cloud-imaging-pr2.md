...
云影像 PR 2 的说明页、主动打开、完整来源与访问资格复查及打开审计已随
[v1.15.0](../releases/v1.15.0.md) 发布。[PR #68](https://github.com/skuyd/emr/pull/68)
经精确提交 CI 通过后合并为 `61dbbc8835702bd998272a036152ea2ba466cede`。
本地应用 `bcf8027a875256c1407ea128b258d847058d36bd` 的异常链隐私问题已修复并独立验证；
此前 PostgreSQL/TLS 浏览器与定向回归继续保留各自源码身份。
...
PR 3 的选定输出与有限分享尚未交付；[PR 1 真实识别的质量限制](batch-three-cloud-imaging-pr1.md)
...
原 GitHub Actions 账号付款/消费额度阻塞证据保留。后续功能头
`0c22276bce62ac206a94c82b50a54b0a1a1c868e` 的
[精确 CI](https://github.com/skuyd/emr/actions/runs/34310861340) 四项成功：普通 2854 通过、
4 跳过，PG 162、必跑浏览器 16、JS 9 均通过且零跳过。PR #68 随后合并，
Release Please 发布 PR #75 确定 v1.15.0 并自动发布。发布及主线 CI 的分开回读见
[追加发布制品](artifacts/release-v1-15-0.json)，原本地测试、身份和独审 JSON 原字节保留。
