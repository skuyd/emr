...
双栏表头及项目代码关联已完成本地验证、独立审查及 CI，随 [v1.5.0](../releases/v1.5.0.md)
发布；事实提取、图像增强及其他批次保持各自交付记录。
...
最终 PR head 为 `ce60e368748454e23255c4417046665bf70a76e6`，经 CI `34143569491` 的
四项检查通过后 Squash 合并，提交为 `be5124e2542cfb0fc7f97a542af11988fa63e69d`。
发布 PR #42 的最终 CI `34145256333` 也通过四项检查，Release Please 实际发布版本为
1.5.0；曾拟定的 1.4.2 未单独发布。精确 head、检查、标签及审查记录摘要见
[交付制品](artifacts/batch-one-labs-delivery.json)。
